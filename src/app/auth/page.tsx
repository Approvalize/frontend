  ...
  return (
    <>
      ...
      <Container className="flex justify-center">
        <div className="max-w-screen-sm mx-auto p-4 sm:p-6 xl:p-8 rounded-sm border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full">
              ...
              <div className="max-w-screen-md mx-auto p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-5">
                    <button
                      type="submit"
                      className="w-full cursor-pointer rounded-lg bg-primary text-white py-4 font-medium text-base hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary-dark"
                    >
                      Sign In
                    </button>
                  </div>
                ...
                {/*<div className="text-center text-black dark:text-white">
                  ...
                  <Link href="/signup">
                    <a className="ml-1 font-bold hover:underline">Sign Up</a>
                  </Link>
                </div>*/}
              </div>
            </div>
