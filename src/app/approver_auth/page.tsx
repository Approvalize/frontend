  ...
  return (
    <>
      ...
      <Container className="flex justify-center">
        <div className="max-w-screen-sm mx-auto p-4 sm:p-6 xl:p-8 rounded-sm justify-center border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full">
